<?xml version="1.0" encoding="UTF-8"?>
                    ...
                    <tei:fileDesc> <!-- contiene le informazioni relative al documento digitale-->
                      <tei:titleStmt> <!-- titolo e responsabili dell'edizione digitale -->
                        ...
                        <tei:respStmt>
                           ...
                           <tei:persName>Dominga Elia</tei:persName>
				                </tei:respStmt>
                        <tei:respStmt>
    ...
    <xsl:template name="date" >
      <tei:opener>
        <tei:dateline>
          <xsl:variable name="S" select="text/retro"/>
  ...
  <xsl:template match="text//salute">
    <tei:closer>
          ...
          <item><n>Remigio</n><c>Dalla</c><c>Valle</c></item><item><c>Fabbri</c><n>A.</n></item><item><n>Bianca</n></item></list></xsl:variable>
